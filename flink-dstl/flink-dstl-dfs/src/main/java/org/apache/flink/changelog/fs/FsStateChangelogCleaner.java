 ...
 */
@Internal
public interface FsStateChangelogCleaner extends AutoCloseable {

    void cleanupAsync(UploadResult uploadResult);

    FsStateChangelogCleaner NO_OP =
            new FsStateChangelogCleaner() {
                @Override
                public void close() {}

                @Override
                public void cleanupAsync(UploadResult storeResult) {}
            };
