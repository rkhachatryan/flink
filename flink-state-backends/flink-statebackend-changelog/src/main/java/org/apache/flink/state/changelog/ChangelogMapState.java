...
class ChangelogMapState<K, N, UK, UV>
    ...
    public void put(UK key, UV value) throws Exception {
        if (getValueSerializer() instanceof MapSerializer) {
            ...
            changeLogger.stateAdded(singletonMap(key, value), currentNamespace);
        }
    ...
    public void putAll(Map<UK, UV> map) throws Exception {
        changeLogger.stateAdded(map, currentNamespace);
        delegatedState.putAll(map);
    }

    @Override
    public void remove(UK key) throws Exception {
        changeLogger.stateElementRemoved(out -> serializeKey(key, out), currentNamespace);
    ...
    public Iterable<UK> keys() throws Exception {
        return loggingIterable(
                delegatedState.keys(), changeLogger, this::serializeKey, currentNamespace);
    }
    ...
    public Iterator<Map.Entry<UK, UV>> iterator() throws Exception {
        return loggingIterator(
                delegatedState.iterator(), changeLogger, changeWriter, currentNamespace);
    }
