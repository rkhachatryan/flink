...
public interface StateChangelogWriter<Handle extends StateChangelogHandle<?>>
    ...
    /**
     * Durably persist previously {@link #append(int, byte[]) appended} data. After this call, one
     * of {@link #confirm(SequenceNumber, SequenceNumber) confirm}, {@link #reset(SequenceNumber,
