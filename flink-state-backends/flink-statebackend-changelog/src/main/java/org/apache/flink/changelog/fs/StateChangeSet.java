...
class StateChangeSet {
    ...
    enum Status {
        ...
        static {
            transitionsTo.put(PENDING, of(SCHEDULED, MATERIALIZED));
            transitionsTo.put(SCHEDULED, of(UPLOADING));
            transitionsTo.put(UPLOADING, of(UPLOADED, PENDING));
            transitionsTo.put(UPLOADED, of(SENT_TO_JM));
            transitionsTo.put(SENT_TO_JM, of(CONFIRMED, PENDING, MATERIALIZED));
            transitionsTo.put(CONFIRMED, of(MATERIALIZED));
