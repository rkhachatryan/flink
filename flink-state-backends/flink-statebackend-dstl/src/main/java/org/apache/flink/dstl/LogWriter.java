...
public interface LogWriter {
	...
	/**
	 * Get {@link SequenceNumber} of the last element added by {@link #append(int, byte[], byte[], long) append}.
	 */
	...
	/**
	 * Close this log.
	 * No new appends will be possible. Any appended but not persisted records will be lost.
	 */
	void close();
}
