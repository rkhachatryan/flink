...
import org.apache.flink.dstl.fs.LogRecordStreamIterator.LogRecordFilter;
...
public class FsLogClient implements LogClient {
	...
	@Override
	public FsDstlWriter createWriter(OperatorID operatorID, KeyGroupRange keyGroupRange) {
		return new FsDstlWriter(persister, LogId.UuidLogId.random());
	}

	@Override
	public CloseableIterator<LogRecord> replay(LogPointer logPointer, SequenceNumber after, SequenceNumber until, KeyGroupRange keyGroupRange) throws IOException {
