...
final class IncrementalHeapSnapshotStrategy<K>
        ...
        return snapshotCloseableRegistry -> {
            ...
            SnapshotResult<KeyedStateHandle> newHandle =
                    new HeapSnapshotStrategy.HeapSnapshotWriter<>(
                                    ...
                                    checkpointId,
                                    streamFactory,
                                    selectMetadataWriter(checkpointOptions))
            ...
            snapshotTracker.track(
                    checkpointId,
                    new IncrementalSnapshot(syncPartResource.getCurrentMapVersions(), newSnapshot),
    ...
    private MetadataWriter<K> selectMetadataWriter(CheckpointOptions checkpointOptions) {
    ...
    public void notifyCheckpointComplete(long checkpointId) {
        snapshotTracker.confirmVersion(checkpointId);
    }
}
