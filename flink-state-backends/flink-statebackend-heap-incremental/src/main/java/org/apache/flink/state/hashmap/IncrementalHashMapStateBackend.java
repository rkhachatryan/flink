...
@Experimental
class IncrementalHashMapStateBackend extends HashMapStateBackend implements StateBackend {
    ...
    protected <K> HeapKeyedStateBackendBuilder<K> createBuilder(
        ...
        UUID backendIdentifier = UUID.randomUUID();

        StateHandleHelper stateHandleHelper =
                new StateHandleHelper(backendIdentifier, keyGroupRange);
        ...
        return new HeapKeyedStateBackendBuilder<>(
                ...
                stateHandleHelper.flattenState(stateHandles),
                ...
                (kvStates, pqStates, keySerializerProvider) ->
                        new IncrementalHeapSnapshotStrategy<>(
                                ...
                                new IncrementalSnapshotTrackerImpl(stateHandles, stateHandleHelper),
                                stateHandleHelper),
                IncrementalCopyOnWriteStateTable::new,
                IncrementalKeyGroupReader.FACTORY,
                IncrementalKeyGroupReader::getSerializationProxy);
    }
