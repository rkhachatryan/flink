...
class IncrementalKeyGroupReader<K, N, S> implements StateSnapshotKeyGroupReader {
    public static KeyGroupReaderFactory FACTORY =
    ...
    public static <K> KeyedBackendSerializationProxy<K> getSerializationProxy(
            ClassLoader classLoader) {
        return new IncrementalKeyedBackendSerializationProxy<>(classLoader);
    }
}
