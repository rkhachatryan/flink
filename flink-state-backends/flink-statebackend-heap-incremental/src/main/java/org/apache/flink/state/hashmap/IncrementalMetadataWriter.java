...
class IncrementalMetadataWriter<K> implements HeapSnapshotStrategy.MetadataWriter<K> {
    ...
    public void write(
        ...
        new IncrementalKeyedBackendSerializationProxy<>(
                        ...
                        !Objects.equals(UncompressedStreamCompressionDecorator.INSTANCE, decorator))
                .write(outView);
    }
}
