...
/**
 * Tracks snapshots for {@link IncrementalHeapSnapshotStrategy}. All methods should be called by the
 * task thread.
 */
@Internal
@NotThreadSafe
interface IncrementalSnapshotTracker {
    ...
    /** Get base for the next snapshot. E.g. last confirmed. */
    ...
    void confirmVersion(long checkpointId);
}
