...
public class MultipleInputTransformationTest {
	...
	public void testNaming() {
		...
		String baseName = getString(random);
		MultipleInputTransformation<Long> transformation =
			new MultipleInputTransformation<>(baseName, unsupportedOperatorFactory(), TypeInformation.of(Long.class), 1);
		for (int i = 0; i < 10; i++) {
		...
		assertTrue(transformation.getName().contains(baseName));
