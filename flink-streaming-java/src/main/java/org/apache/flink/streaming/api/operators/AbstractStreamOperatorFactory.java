 ...
 * {@link ProcessingTimeServiceAware} which gives stream operators to access to the {@link ProcessingTimeService}.
 *
 * <p>For an stream operator, if it needs to access the {@link ProcessingTimeService}, it
 * must implement {@link ProcessingTimeServiceAware}. And then the {@link ProcessingTimeService}
 * is set into the stream operator by the stream operator factory.
 */
