...
/**
 * Flink {@link org.apache.hadoop.fs.s3a.S3ClientFactory}. Allows to set AWS SDK specific parameters
 * such as request timeout.
 */
public class FlinkS3ClientFactory extends DefaultS3ClientFactory {
    ...
    protected AmazonS3 newAmazonS3Client(
        ...
        getProperty("requestTimeoutMs")
                ...
                .ifPresent(awsConf::setRequestTimeout);
        getProperty("maxErrorRetry")
                .map(Integer::parseInt)
                .ifPresent(awsConf::setMaxErrorRetry); // todo: review fs.s3a.attempts.maximum
