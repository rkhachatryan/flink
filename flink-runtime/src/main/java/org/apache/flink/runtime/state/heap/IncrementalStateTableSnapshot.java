...
class IncrementalStateTableSnapshot<K, N, S> implements StateSnapshot, StateSnapshot.StateKeyGroupWriter {
	...
	public void writeStateInKeyGroup(@Nonnull DataOutputView dov, int keyGroupId) throws IOException {
		writeStateInKeyGroup(dov, keyGroupId, Optional.empty());
	}
