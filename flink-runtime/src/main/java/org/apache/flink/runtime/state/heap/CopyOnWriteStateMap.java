...
//		Set<EntryHolder<K, N, S>> rr = new HashSet<>();
//		// todo: cleanup removals incrementally
//		// todo: compute cleanup version using JM notification or config
//		removed.forEach(e -> {
//			if (canRemovalBeRemoved(e.e)) {
//				// todo: don't remove if was added again
//				rr.add(e);
//				removeEntry(e.e.key, e.e.namespace, false);
//			}
//		});
//		removed.removeAll(rr);
