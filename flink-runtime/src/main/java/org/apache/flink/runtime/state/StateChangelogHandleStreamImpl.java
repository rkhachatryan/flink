...
public final class StateChangelogHandleStreamImpl
    ...
    // todo low: deduplicate underlying handles
    private final List<Tuple2<StreamStateHandle, Long>> handlesAndOffsets;
    // todo low: refactor existing code to pass this to discard
    ...
    public KeyedStateHandle getIntersection(KeyGroupRange keyGroupRange) {
        ...
        // todo low: filter out some handlesAndOffsets?
    ...
    public long getStateSize() {
        return 0; // todo low: compute state size
    }
