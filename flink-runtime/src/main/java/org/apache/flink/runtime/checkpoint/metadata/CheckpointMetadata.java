...
public class CheckpointMetadata implements Disposable {
	...
	private final Collection<TaskChannelsState> channelsStates;
	...
	public CheckpointMetadata(long checkpointId, Collection<OperatorState> operatorStates, Collection<MasterState> masterStates) {
		this(checkpointId, operatorStates, Collections.emptyList(), masterStates);
	}

	public CheckpointMetadata(
			long checkpointId,
			Collection<OperatorState> operatorStates,
			Collection<TaskChannelsState> channelsStates,
			Collection<MasterState> masterStates) {
		this.checkpointId = checkpointId;
		this.operatorStates = operatorStates;
		this.masterStates = checkNotNull(masterStates, "masterStates");
		this.channelsStates = checkNotNull(channelsStates);
	}
	...
	public Collection<TaskChannelsState> getChannelsStates() {
	...
	public void dispose() throws Exception {
		...
		for (TaskChannelsState channelsState : channelsStates) {
			channelsState.discardState();
		}
